...
// in order to use httpresponsemessage add the above namespace
using System.Web;
...
namespace Mvc.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult AddorEdit(mvcEmployeeModel emp)
        {
            ...
            {
                HttpResponseMessage response = GlobalVariables.WebApiClient.PutAsJsonAsync("Employee/"+emp.Employee1, emp).Result;
